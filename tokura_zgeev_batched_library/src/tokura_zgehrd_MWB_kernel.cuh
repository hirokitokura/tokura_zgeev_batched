...
(
	...
	cuDoubleComplex* house_vector_shared,//�n�E�X�z���_�[�x�N�g��
...
)
{
	...
	cuDoubleComplex* house_vector_shared = &shared_dynamic[0];//�n�E�X�z���_�[�x�N�g���ۑ��p
	double* reduction_shared = (double*)& house_vector_shared[(matrix_size - 1) * MWB_WARP_SIZE];//���_�N�V�����p
...
)
{
	...
	cuDoubleComplex* house_vector_shared = &matrix_shared[matrix_size * matrix_size * MWB_WARP_SIZE];//�n�E�X�z���_�[�x�N�g���ۑ��p
	double* reduction_shared = (double*)& house_vector_shared[(matrix_size - 1) * MWB_WARP_SIZE];//���_�N�V�����p
	cuDoubleComplex inner_product;
	cuDoubleComplex tmp;
	int index;
